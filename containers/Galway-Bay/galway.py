    ...
    try:
        ...
        for name, longitude, latitude, distance, bearing in zip(names, longitudes, latitudes, distances, bearings):
            ...
            if tipo == 0.0: # Point is on land. Wrong site. Change LAT, LON
                ...
                if name == 'Bellharbour': # EXCEPTION ADDED ON 26/03/2024 TO USE BISHOP'S
                                          # QUARTER SEA LEVEL SERIES FOR BELLHARBOUR
                    logger.info(f"{now()} Using Bishop's Quarter sea level series...")
                    tideS = zeta[:, 35, 81] 
                else:
                    # Find nearest indexes at sea. Get sea level series
