...
def wind_rose(time, wind_rose_data, vartype):
    ...
    if vartype == 'wind':
        ...
        speed_bins = ['0-20 cm/s', '20-40 cm/s', '40-50 cm/s', '50-60 cm/s', 
                      '60-70 cm/s', '70-80 cm/s', '80-90 cm/s', '90-100 cm/s', '>1 m/s']
    ...
    if vartype == 'wind':
        ...
        bin_edges_speed = np.array([0, 20, 40, 50, 60, 70, 80, 90, 100, threshold_outlier_rm])
